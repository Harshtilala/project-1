<aside id="sidebar" class="sidebar" style="background-color: #eef2f7;">
  <div class="sidebar-header">
    <a href="{{ route('dashboard') }}"><img
        src="{{ asset('images/WhatsApp_Image_2025-09-18_at_7.18.19_PM-removebg-preview.png') }}" alt="Company Logo"
        class="logo" width="220"></a>
  </div>
  ...
  <nav class="nav">
    ...
    <details class="menu-group" id="menu-master">
      ...
      <div class="submenu">
        ...
        <a href="{{ route('diamond_stocks.index') }}" class="submenu-item" data-icon="💎">
          Diamond Stock
        </a>

        <a href="{{ route('karat.index') }}" class="submenu-item" data-icon="🎚️">
          Karat Stock
        </a>

        <a href="{{ route('stockstatus.index') }}" class="submenu-item" data-icon="📊">
          Stock Status
        </a>
