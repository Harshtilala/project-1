    ...
    <main class="content" style="flex: 1; padding: 24px; overflow-y: auto; background-color: #f4f6f9;">
        <div class="container-fluid">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h2 class="fw-bold mb-1">Add Karat Wise Stock</h2>
                </div>
            </div>`
            <!-- Main Card -->
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <input type="text" name="name"
                                        ...
                                        placeholder="e.g. Gold Jewellery" value="{{ old('name') }}">
                                    ...
                                    <div class="card h-100 border-0 shadow-sm">
                                        <div class="card-body">
                                            ...
                                            <input type="number" name="stock_22k"
                                                ...
                                                placeholder="Enter quantity" value="{{ old('stock_22k') }}">
                                            @error('stock_22k')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="card h-100 border-0 shadow-sm">
                                        <div class="card-body">
                                            ...
                                            <input type="number" name="stock_18k"
                                                ...
                                                placeholder="Enter quantity" value="{{ old('stock_18k') }}">
                                            @error('stock_18k')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="card h-100 border-0 shadow-sm">
                                        <div class="card-body">
                                            ...
                                            <input type="number" name="stock_14k"
                                                ...
                                                placeholder="Enter quantity" value="{{ old('stock_14k') }}">
                                            @error('stock_14k')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
