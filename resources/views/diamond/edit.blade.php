...
<div class="container mt-5">
    <h2 class="mb-4">Edit Diamond Stock</h2>

    @if(session('success'))
        <div class="alert alert-success">{{ session('success') }}</div>
    @endif

    <form action="{{ route('diamond_stocks.update', $diamondStock->id) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="mb-3">
            ...
            <input type="text"
                   ...
                   id="name"
                   name="name"
                   value="{{ old('name', $diamondStock->name) }}"
        ...
        <div class="mb-3">
            ...
            <input type="text"
                   ...
                   id="natural"
                   name="natural"
                   value="{{ old('natural', $diamondStock->natural) }}"
        ...
        <div class="mb-3">
            ...
            <input type="text"
                   ...
                   id="lab_grown"
                   name="lab_grown"
                   value="{{ old('lab_grown', $diamondStock->lab_grown) }}"
        ...
        <div class="mb-3">
            ...
            <input type="text"
                   ...
                   id="cvd"
                   name="cvd"
                   value="{{ old('cvd', $diamondStock->cvd) }}"
        ...
        <div class="d-flex">
            <button type="submit" class="btn btn-primary me-2">Update Diamond Stock</button>
